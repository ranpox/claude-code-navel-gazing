...
## Main System Prompt (COMPLETE)

Found in `cli-prettified.js` - assembled from function `SA1()` and related functions:
...
You can use the following tools without requiring user approval: [dynamic list based on permissions]
...
The system prompt can be modified by Output Modes. Found these built-in modes:
...
### MultiEdit Tool
**Name**: MultiEdit  
**Short Description**: Make multiple edits to a single file.  
**Full Description**:
```
...
### NotebookEdit Tool
**Name**: NotebookEdit  
**Short Description**: Replace the contents of a specific cell in a Jupyter notebook.  
**Full Description**:
```
...
### Agent (Task) Tool
**Name**: Task  
**Short Description**: Launch specialized subagents.  
**Full Description**:
```
